...
const SOCIALS = [
  {
    name: "Facebook",
    icon: (
      <Icon icon={Icons.facebookFill} width={24} height={24} color="#1877F2" />
    ),
  },
  {
    name: "Instagram",
  ...
  },
  {
    name: "Linkedin",
    icon: (
      <Icon icon={Icons.linkedinFill} width={24} height={24} color="#006097" />
    ),
  },
  {
    name: "Twitter",
    icon: (
      <Icon icon={Icons.twitterFill} width={24} height={24} color="#1C9CEA" />
    ),
  },
];
